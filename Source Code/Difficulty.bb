...
difficulties(THAUMIEL)\name = "Таумиэль" ;Thaumiel
difficulties(THAUMIEL)\description = "Объекты класса Таумиэль - аномалии, которые Фонд используется для сдерживания или противодействия других аномалиям.Сама информация о существовании объектов класса Таумиэль является секретной " ;Thaumiel-class SCPs are anomalies that the Foundation uses to contain or counteract other SCPs or anomalous phenomena. Even the mere existence of Thaumiel-class objects 
